  ...
  for spawn in pairs(spawnData) do
    if (strfind(strlower(spawn), strlower(search))) then
      if ( spawnCount <= 13) then
        ...
        SQG_SpawnButtons["Button_"..spawnCount]:SetNormalTexture(nil)
        SQG_SpawnButtons["Button_"..spawnCount]:SetPushedTexture(nil)
  ...
  for spawn in pairs(itemData) do
    if (strfind(strlower(spawn), strlower(search))) then
      if ( itemCount <= 13) then
        ...
        SQG_ItemButtons["Button_"..itemCount]:SetNormalTexture(nil)
        SQG_ItemButtons["Button_"..itemCount]:SetPushedTexture(nil)
  ...
  for spawn in pairs(vendorData) do
    if (strfind(strlower(spawn), strlower(search))) then
      if ( vendorCount <= 13) then
        ...
        SQG_VendorButtons["Button_"..vendorCount]:SetNormalTexture(nil)
        SQG_VendorButtons["Button_"..vendorCount]:SetPushedTexture(nil)
...
function SQG_ShowFavourites()
  for i = 1,13 do
    if ( SQG_Favourites["spawn"][i] ~= '' ) then
      ...
      SQG_SpawnButtons["Button_"..i]:SetNormalTexture(nil)
      SQG_SpawnButtons["Button_"..i]:SetPushedTexture(nil)
    ...
    if ( SQG_Favourites["item"][i] ~= '') then
      ...
      SQG_ItemButtons["Button_"..i]:SetNormalTexture(nil)
      SQG_ItemButtons["Button_"..i]:SetPushedTexture(nil)
    ...
    if ( SQG_Favourites["vendor"][i] ~= '' ) then
      ...
      SQG_VendorButtons["Button_"..i]:SetNormalTexture(nil)
      SQG_VendorButtons["Button_"..i]:SetPushedTexture(nil)
...
function SQG_EditFavourites()
  ...
  for i = 1,13 do
    ...
    SQG_FavouritesEdit["SpawnEdit"..i] = CreateFrame("EditBox", "InputBoxTemplateS"..i, SQG)
    SQG_FavouritesEdit["SpawnEdit"..i]:SetBackdrop(backdrop)
    SQG_FavouritesEdit["SpawnEdit"..i]:SetBackdropBorderColor(0.2,0.2,0.2,1)
    ...
    SQG_FavouritesEdit["SpawnEdit"..i]:SetPoint("TOPLEFT", 20, -i*22-53)
    ...
    SQG_FavouritesEdit["SpawnEdit"..i]:SetTextInsets(8,8,0,0)
    SQG_FavouritesEdit["SpawnEdit"..i]:SetScript("OnTextChanged", function(self)
        SQG_Favourites["spawn"][this.editID] = this:GetText()
      end)
    SQG_FavouritesEdit["SpawnEdit"..i]:SetScript("OnEscapePressed", function(self)
        this:ClearFocus()
      end)

    SQG_FavouritesEdit["ItemEdit"..i] = CreateFrame("EditBox", "InputBoxTemplateI"..i, SQG)
    SQG_FavouritesEdit["ItemEdit"..i]:SetBackdrop(backdrop)
    SQG_FavouritesEdit["ItemEdit"..i]:SetBackdropBorderColor(0.2,0.2,0.2,1)
    ...
    SQG_FavouritesEdit["ItemEdit"..i]:SetPoint("TOP", 0, -i*22-53)
    ...
    SQG_FavouritesEdit["ItemEdit"..i]:SetTextInsets(8,8,0,0)
    SQG_FavouritesEdit["ItemEdit"..i]:SetScript("OnTextChanged", function(self)
        SQG_Favourites["item"][this.editID] = this:GetText()
      end)
    SQG_FavouritesEdit["ItemEdit"..i]:SetScript("OnEscapePressed", function(self)
        this:ClearFocus()
      end)

    SQG_FavouritesEdit["VendorEdit"..i] = CreateFrame("EditBox", "InputBoxTemplateV"..i, SQG)
    SQG_FavouritesEdit["VendorEdit"..i]:SetBackdrop(backdrop)
    SQG_FavouritesEdit["VendorEdit"..i]:SetBackdropBorderColor(0.2,0.2,0.2,1)
    ...
    SQG_FavouritesEdit["VendorEdit"..i]:SetPoint("TOPRIGHT", -20, -i*22-53)
    ...
    SQG_FavouritesEdit["VendorEdit"..i]:SetTextInsets(8,8,0,0)
    SQG_FavouritesEdit["VendorEdit"..i]:SetScript("OnTextChanged", function(self)
        SQG_Favourites["vendor"][this.editID] = this:GetText()
      end)
    SQG_FavouritesEdit["VendorEdit"..i]:SetScript("OnEscapePressed", function(self)
        this:ClearFocus()
      end)
  end
end
